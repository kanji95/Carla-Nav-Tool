...
class SensorManager:
    ...
    def save_rgb_image(self, image):
        ...
        print(np.array(image.transform.get_inverse_matrix()))
...
def run_simulation(args, client):
    ...
    try:
        ...
        vehicle = world.spawn_actor(
            bp, carla.Transform(carla.Location(x=0, y=0, z=10.0)))
        ...
        SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=0, z=150), carla.Rotation(pitch=-90)),
