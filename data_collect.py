...
class World(object):
    ...
    def restart(self, args):
        ...
        while self.player is None:
            ...
            # Fix Spawning Point
            # vector = [99.43485260009766, -
            #           19.65771484375, 0.311619682423770428, 90]
            # spawn_point = carla.Transform(carla.Location(
            #     x=vector[0], y=vector[1], z=vector[2]), carla.Rotation(yaw=vector[3]))
...
class CameraManager(object):
    ...
    def _parse_image(weak_self, image):
        ...
        if self.recording and (command_given or checked) and saving[0]:
    ...
    try:
        ...
        while True:
            ...
            if agent.done() and command_given:
                command_given = False
                # comment if you want have frames after target reached.
                checked = False
                print('Done')
